...
public class TestRecTest {
	...
	public void test() {
		...
		BufferedImage im1 = new TestRec().loadSingleSpriteByPath("screen_win.png");
		BufferedImage im2 = new TestRec().loadSingleSpriteByPath("Screen1.png");
		...
		assert (!(new TestRec().sontEgales(im2, new TestRec().loadSingleSpriteByPath("sprites/youwin.png"), 90)));
