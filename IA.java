...
public class IA extends ToolBox {
	...
	public IA(Rectangle rec) throws AWTException {
		...
		this.zones.addZone("Tel_Topping", new Dot((1086./1286.) * this.width,
				(552./956.) * this.height));
		this.zones.addZone("Tel_Rice", new Dot((1086./1286.) * this.width,
				(590./956.) * this.height));
		
		this.zones.addZone("Tel_Shrimp", new Dot((994./1286.) * this.width,
				(551./956.) * this.height));
		this.zones.addZone("Tel_Nori", new Dot((994./1286.) * this.width,
				(551./956.) * this.height));
		this.zones.addZone("Tel_FishEggs", new Dot((1156./1286.) * this.width,
				(551./956.) * this.height));
		this.zones.addZone("Tel_Rice", new Dot((1150./1286.) * this.width,
				(570./956.) * this.height));
		this.zones.addZone("Checkout", new Dot((780./1016.) * this.width,
				(470./761.) * this.height));
		
		this.zones.addZone("plate1", new Dot((163./1274.) * this.width, (413./959.) * this.height));
		this.zones.addZone("plate2", new Dot((363./1274.) *  this.width, (413./959.) * this.height));
		this.zones.addZone("plate3", new Dot((563./1274.) * this.width, (413./959.) * this.height));
		this.zones.addZone("plate4", new Dot((763./1274.) * this.width, (413./959.) * this.height));
		this.zones.addZone("plate5", new Dot((968./1274.) * this.width, (413./959.) * this.height));
		this.zones.addZone("plate6", new Dot((1168./1274.) * this.width, (413./959.) * this.height));
		...
		this.bulles.addZone("Bulle2", new Dot((272. / 1236.) * this.width,
				(98. / 928.) * this.height), 64*(1236./(double)this.width), 69*(959./this.height));
		this.bulles.addZone("Bulle3", new Dot((467. / 1236.) * this.width,
				(98. / 928.) * this.height), 64*(1236./(double)this.width), 69*(959./this.height));
		this.bulles.addZone("Bulle4", new Dot((662. / 1236.) * this.width,
				(98. / 928.) * this.height), 64*(1236./(double)this.width), 69*(959./this.height));
		this.bulles.addZone("Bulle5", new Dot((858. / 1236.) * this.width,
				(98. / 928.) * this.height), 64*(1236./(double)this.width), 69*(959./this.height));
		this.bulles.addZone("Bulle6", new Dot((1053. / 1236.) * this.width,
				(98. / 928.) * this.height), 64*(1236./(double)this.width), 69*(959./this.height));
	...
	public String getSushi(BufferedImage sushiToTest) {
		...
		for (BufferedImage tempImg : this.sushiReference.keySet()) {
			...
			if (ir.areTheseImagesEqualInvertMethod(this.sushiReference.get(tempImg),sushiToTest, 70))
